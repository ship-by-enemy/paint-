...
if(width<992){
    document.getElementById("c_1").width = new_width;
    document.getElementById("c_1").height = new_height;
...
function my_touchmove(e){
    ...
    current_position_of_touch_y = e.touches[0].clientY-canvas.offsetTop;  
        ...
        ctx.stroke();
    last_positionX = current_position_of_touch_x;
        last_positionY = current_position_of_touch_y;
}
function clearArea(){
